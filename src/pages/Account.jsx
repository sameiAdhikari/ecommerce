        ...
        <div className=" mt-[7.6rem] bg-gray-100 flex">
          <aside className=" w-64 bg-white shadow-md p-6 hidden md:block">
            ...
            <ul className=" h-[70vh] text-xl space-y-4 text-gray-700">
              ...
              <li className="mt-60 w-full h-[2.5rem] text-stone-50 flex justify-center items-center bg-red-600 hover:bg-red-700 transition-all duration-200 cursor-pointer">
                <button
